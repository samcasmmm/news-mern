...
app.get('/', function (req, res) {
    res.json({
        token: (0, generateToken_1["default"])({ res: res, userId: '123456789' })
    });
});
routes_1.ROUTES.forEach(function (api) {
    var middleware = api.middleware ? api.middleware.map(function (m) { return m; }) : [];

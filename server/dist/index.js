...
var logger_middleware_1 = __importDefault(require("./middlewares/logger.middleware"));
// Initialize App
...
app.use((0, helpers_1.pathBuilder)('/users'), users_route_1.default);
app.use((0, helpers_1.pathBuilder)('/posts'), posts_route_1.default);
// Middlewares
